...
import DjangoAPI.db as DataBase
...
SECRET_KEY = 'django-insecure--b=rmwz#ck48#v#l@kihwl_3qw8*xi^bi-cem72m)3qv8nd_qv'
...
# desactivamos este campo como testing
# STATIC_URL = 'static/'
...
LOGIN_REDIRECT_URL = '/myapi/dashboard/'
